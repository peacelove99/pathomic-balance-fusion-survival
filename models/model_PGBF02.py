...
class PGBF_Surv01(nn.Module):
    ...
    def forward(self, **kwargs):
        ...
        if only_omic:
            ...
            # Genomic Decoder
            h_omic_trans = self.omic_transformer(patch_token_genomics_encoder)  # MCAT & MOTCat [6, 256]
        ...
        if only_path:
            ...
            # Pathology Decoder
            h_path_trans = self.path_transformer(patch_token_pathology_encoder)  # MCAT & MOTCat
