...
class CMTA(nn.Module):
    def __init__(self, omic_sizes=[100, 200, 300, 400, 500, 600], n_classes=4, fusion="concat", model_size="small"):
        ...
        # P->G Attention
        self.P_in_G_Att = MultiheadAttention_CMTA(embed_dim=256, num_heads=1)
        # G->P Attention
        self.G_in_P_Att = MultiheadAttention_CMTA(embed_dim=256, num_heads=1)
...
class MultiheadAttention_CMTA(Module):
    ...
    Examples::
        ...
        >>> multihead_attn = nn.MultiheadAttention_CMTA(embed_dim, num_heads)
    ...
    def __init__(
        ...
        super(MultiheadAttention_CMTA, self).__init__()
    ...
    def __setstate__(self, state):
        ...
        super(MultiheadAttention_CMTA, self).__setstate__(state)
